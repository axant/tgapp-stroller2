...
class TestController(object):
    ...
    The sample-ecommerce application instance (``self.app``) set up in this test
    case (and descendants) has authentication disabled, so that developers can
    test the protected areas independently of the :mod:`repoze.who` plugins
    used initially. This way, authentication can be tested once and separately.

    Check sampleecommerce.tests.functional.test_authentication for the repoze.who
    integration tests.
    ...
    admin_environ = {'REMOTE_USER': 'manager@somedomain.com'}
    editor_environ = {'REMOTE_USER': 'editor@somedomain.com'}
