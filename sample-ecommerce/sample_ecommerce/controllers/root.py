...
from sample_ecommerce.controllers.secure import SecureController
...
class RootController(BaseController):
    ...
    def _before(self, *args, **kw):
        tmpl_context.project_name = "sample_ecommerce"
    ...
    @expose('sample_ecommerce.templates.about')
    def about(self):
        """Handle the 'about' page."""
        return dict(page='about')

    @expose('sample_ecommerce.templates.environ')
    def environ(self):
        """This method showcases TG's access to the wsgi environment."""
        return dict(page='environ', environment=request.environ)

    @expose('sample_ecommerce.templates.data')
    @expose('json')
    def data(self, **kw):
    ...
    @expose('sample_ecommerce.templates.login')
